...
function foghorn_setup() {
	...
	//set_post_thumbnail_size( 150, 300 ); // 50 pixeis de largura por 50 pixeis de altura, no modo box-resizing.

	add_image_size( 'single-post-thumbnail', 600, 300 ); // imagem para página de post
